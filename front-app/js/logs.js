...
document.addEventListener("DOMContentLoaded", () => {
    ...
    document.getElementById("tabela-logs").style.display = "none";
...
function carregarLogsComFiltros() {
    ...
    fetch(url, {
        ...
        .then(data => {
            ...
            // ✅ CORREÇÃO: Mostra a tabela SOMENTE após os dados serem carregados.
            document.getElementById("tabela-logs").style.display = "table";
        })
        .catch(err => {
